        ...
        <div className="post">
          <article className="post-content resume">
            ...
            <h4 id="software-engineer-thing-daemon-fancy-oct-2015--">
              Software Engineer,{" "}
              <a href="http://www.fancy.com">Thing Daemon (Fancy)</a>{" "}
              <sub className="sub-date">Oct 2015 – </sub>
            </h4>
            <ul>
            <li>Work as remote team</li>
            <li>Developed and managed the most of JavaScript used projects in the customer-seeing website, admin and merchant tools (React, jQuery)</li>
            <li>Built and managed JS bundle system (Webpack, Babel) used for the website</li>
            <li>Django-based Backend development for web/app API</li>
            </ul>

            <h4 id="software-engineer-spoqa-inc-march-2014--oct-2015">
              Software Engineer, <a href="http://www.spoqa.com">Spoqa Inc.</a>{" "}
            ...
            <ul>
              ...
              <li>
                Designed and developed Front-end web development workflow and
                test environment
              </li>
              <li>
              ...
              <li>
                Developed Dodo Point landing page (http://dodopoint.com) and
                conducted growth hack tasks using Heroku, Flask, Libsass-python,
                Postgres, Google Analytics, Crazyegg (resulted minimum 300% Conversion
                rate boost)
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    <a href="http://www.crevate.com">http://www.crevate.com/</a>
                  </li>
                  <li>
            ...
            <ul>
              ...
              <li>
                Work experience with Node.js, jQuery, React, Babel.js,
                Greensock, Bash, Jekyll, Git, JIRA, Github, Stash, …
              </li>
              <li>
            ...
            <ul>
              <li>
                <a href="https://github.com/webpack-contrib/svg-inline-loader">
                  webpack-contrib/svg-inline-loader (merged into
                  webpack-contrib)
                </a>
              </li>
              <li>
